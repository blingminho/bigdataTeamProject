     ...
     <% Calendar cal = Calendar.getInstance(); %>
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          [<%=cal.get(Calendar.MONTH)-4%>+'월',  12,      100],
          [<%=cal.get(Calendar.MONTH)-3%>+'월',  36,      280],
          [<%=cal.get(Calendar.MONTH)-2%>+'월',  80,      500],
          [<%=cal.get(Calendar.MONTH)-1%>+'월',  113,      800],
          [<%=cal.get(Calendar.MONTH)%>+'월',  278,       300],
          [<%=cal.get(Calendar.MONTH)+1%>+'월',  600,      100]
        ]);
  	 			...
  	 			success:function(){
				    ...
				    function drawChart() {
				    	var data = google.visualization.arrayToDataTable([
				    		 ['Month', 'Members', 'Visitors'],
				             [<%=cal.get(Calendar.MONTH)-4%>+'월',  12,      100],
				             [<%=cal.get(Calendar.MONTH)-3%>+'월',  355,      250],
				             [<%=cal.get(Calendar.MONTH)-2%>+'월',  80,      500],
				             [<%=cal.get(Calendar.MONTH)-1%>+'월',  113,      800],
				             [<%=cal.get(Calendar.MONTH)%>+'월',  278,       900],
				             [<%=cal.get(Calendar.MONTH)+1%>+'월',  34,      200]
				        ]);
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Happy Puppy v1.0</a>
			</div>
			<!-- /.navbar-header -->

			<ul class="nav navbar-top-links navbar-right">
				<!-- /.dropdown 편지표시 내리는거 나타내는 거 -->
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge"><%=adminToday.getVisitTodayCount() %></div>
					...
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge"><%=adminToday.getRegTodayCount() %></div>
									<div>New Members!</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-yellow">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge"><%=adminToday.getPuppyTodayCount() %></div>
									<div>New Animals!</div>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-red">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge"><%=adminToday.getPostTodayCount() %></div>
									<div>New Post!</div>
								</div>
							</div>
						</div>
