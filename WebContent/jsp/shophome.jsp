							...
							<div class="thumbnail">
								...
								<figcaption>
									...
									<br><br><br><br><br><br><br><br><br><br><h4>
										<a href="detail.puppy?popfile=<%out.print(animalList.get(i).getPopfile());%>">
										<%out.print(animalList.get(i).getProcessState());%></a>
									</h4>
									<br>
									<p><%out.print(animalList.get(i).getCareAddr());%></p>
									<%
										if (i % 3 == 2) {
												out.print("<br><br>");
										}
